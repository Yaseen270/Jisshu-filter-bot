...
async def refer(bot, message):
    ...
    m=await message.reply_sticker("CAACAgUAAxkBAAEDSUFohhXjeu3upX_6Ef03yjYwHVgiWAACzxUAAqjlMFQ_YGXrfkvmmh4E")      
    await m.delete()
    reply_markup = InlineKeyboardMarkup(btn)
    await message.reply_photo(
